    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Special identifier for every creator")
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorId = table.Column<int>(type: "int", nullable: false, comment: "Id of the creator who is the creator."),
                    ...
                    CreatorId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorId = table.Column<int>(type: "int", nullable: false, comment: "Identifier which saves the id of the creator."),
                    CreatorId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "6d5800ce-d726-4fc8-83d9-d6b3ac1f591e", 0, "7975fa86-4225-431f-a86d-2704aeec9a23", "guest@mail.com", false, false, null, "guest@mail.com", "guest@mail.com", "AQAAAAEAACcQAAAAELozyQCg/ZbTNqIwDcAAbfgwcLPlmuRP4XnYOok8b30TajpSu/QYGIPKRWiyk59/Dg==", null, false, "b4acfcde-5a61-45de-bfe9-eb059dc007a2", false, "guest@mail.com" },
                    { "dea12856-c198-4129-b3f3-b893d8395082", 0, "1852579a-5dba-426e-a3a2-8ba76f4e4a23", "creator@mail.com", false, false, null, "creator@mail.com", "creator@mail.com", "AQAAAAEAACcQAAAAED28p/vuelbetxMub0lDa7oqyF3iOj+agP0T3bB8Ya/iDFIB0d/i7cc4797dV0Csqw==", null, false, "6a0e794d-9966-48a5-b8c0-856fe859f7cd", false, "creator@mail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Rezbart", "creator@mail.com", "Daniel Atanasov", "", "+359888888888", "dea12856-c198-4129-b3f3-b893d8395082", "https://www.facebook.com/rezbart.bg" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, 1, null, "Introduction in the world of creatng.", 3, "", "Veliko Tarnovo", "Working with common tools" },
                    { 2, 2, 1, null, "Start dealing with toold which need more experience in this sphere of creating.", 6, "", "Veliko Tarnovo", "Working with advanced tools" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, null, "Light restoration of an axe with pyrographing Dulot's mark.", "https://scontent.fsof8-1.fna.fbcdn.net/v/t39.30808-6/434946900_973518331450547_6779376460553241297_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_ohc=WKL0Ue-x9C0Ab5dlbGX&_nc_ht=scontent.fsof8-1.fna&oh=00_AfBFjpOstWev93jV0N4bbinwWIkC6LZGlSo9qQbawqpqyw&oe=661950D9", 50.00m, 2, "Restavrated Axe" },
                    { 2, 1, null, "I also used searing and some pyrography to make it.", "https://scontent.fsof8-1.fna.fbcdn.net/v/t39.30808-6/411834478_895715185897529_2597910820054918143_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=5f2048&_nc_ohc=IsEJHhi4D9QAb7ayrT8&_nc_ht=scontent.fsof8-1.fna&oh=00_AfALkCPjPaMx4OV1wEVUKutMsZP731BV-LHCtlU_TQgLqw&oe=66197E58", 75.00m, 2, "Handmade wood carving of an Owl in a hollow." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Do some creations only by using hammer", "Working with hammer" },
                    { 2, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Do some creations only by using engraver", "Working with engraver" }
                });
